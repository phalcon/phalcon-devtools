...
final class AbstractGeneratorTest extends Unit
{
    private const CLASS_NAME = 'AbstractEntity';
    ...
    public function testPrint(): void
    {
        ...
        $this->assertStringContainsString('class AbstractEntity extends BaseEntity', $code);
    }
    ...
    public function testAbstract(): void
    {
        ...
        $this->assertStringContainsString('abstract class AbstractEntity extends BaseEntity', $code);
    }
