...
class ServeTest extends \Codeception\Test\Unit
{
    ...
    public function testGeneratedCommandWithNoParameters()
    {
        ...
        $this->assertStringContainsString('php -S 0.0.0.0:8000 -t .htrouter.php -t public', $command);
    }
    ...
    public function testGeneratedCommandWithHostnameOnly()
    {
        ...
        $this->command->parseParameters([], []);
        $command = $this->command->shellCommand();
        $this->assertStringContainsString('php -S localhost:8000 -t .htrouter.php -t public', $command);
    }
    ...
    public function testGeneratedCommandWithPortOnly()
    {
        ...
        $this->command->parseParameters([], []);
        $command = $this->command->shellCommand();
        $this->assertStringContainsString('php -S 0.0.0.0:1111 -t .htrouter.php -t public', $command);
    }
    ...
    public function testGeneratedCommandWithBasepathOnly()
    {
        ...
        $this->command->parseParameters([], []);
        $command = $this->command->shellCommand();
        $this->assertStringContainsString('php -S 0.0.0.0:8000 -t /root/bin.php -t public', $command);
    }
    ...
    public function testGeneratedCommandWithDocumentRootOnly()
    {
        ...
        $this->command->parseParameters([], []);
        $command = $this->command->shellCommand();
        $this->assertStringContainsString('php -S 0.0.0.0:8000 -t .htrouter.php -t not_too_public', $command);
    }
    ...
    public function testGeneratedCommandWithConfigOnly()
    {
        ...
        $this->command->parseParameters([], []);
        $command = $this->command->shellCommand();
        $this->assertStringContainsString('php -S 0.0.0.0:8000 -t .htrouter.php -t public -c awesome.ini', $command);
    }
}
