...
class ScaffoldDBM extends Command implements CommandsInterface
{
	...
	public function getHelp()
	{
		...
		print Color::colorize('  Creates a scaffold Database Management from a database table') . PHP_EOL . PHP_EOL;

		print Color::head('Usage:') . PHP_EOL;
		print Color::colorize('  scaffold-dbm ', Color::FG_GREEN) . PHP_EOL . PHP_EOL;
