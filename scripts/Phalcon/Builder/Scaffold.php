...
class Scaffold extends Component
{
    ...
    private function makeController()
    {
        ...
        if (file_exists($controllerPath)) {
            if (!$this->options->offsetExists('force')) {
                return;
            }
        }
        ...
        if ($this->options->offsetExists('controllersNamespace') &&
    ...
    private function makeLayouts()
    {
        ...
        if (!file_exists($viewPath) || $this->options->offsetExists('force')) {
            // View model layout
            $code = '';
            if ($this->options->offsetExists('theme')) {
    ...
    private function makeViewSearch()
    {
        ...
        if ($this->options->offsetExists('genSettersGetters')) {
