...
define('CPHALCON_DIR' , realpath(__DIR__ . '/../../cphalcon/ext/phalcon/'));
...
$fileVersion = file_get_contents(CPHALCON_DIR . '/../php_phalcon.h');
preg_match('/PHP_PHALCON_VERSION     "([0-9\.[a-z]+)"/', $fileVersion, $matches);
$version = $matches[1];
